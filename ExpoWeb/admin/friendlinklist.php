...
&nbsp;&nbsp;<a href="<?php echo $friendlink_list->PageUrl() ?>export=xml">导出到 XML</a>
...
<?php if ($friendlink->linkname->Visible) { // linkname ?>
	...
	<?php } else { ?>
		<td class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $friendlink->SortUrl($friendlink->linkname) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr><td>链接名称&nbsp;(*)</td><td style="width: 10px;"><?php if ($friendlink->linkname->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($friendlink->linkname->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></table>
		</td>
	<?php } ?>
<?php } ?>		
<?php if ($friendlink->linkorder->Visible) { // linkorder ?>
	...
	<?php } else { ?>
		<td class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $friendlink->SortUrl($friendlink->linkorder) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr><td>链接排序</td><td style="width: 10px;"><?php if ($friendlink->linkorder->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($friendlink->linkorder->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></table>
		</td>
	<?php } ?>
<?php } ?>		
<?php if ($friendlink->Export == "") { ?>
