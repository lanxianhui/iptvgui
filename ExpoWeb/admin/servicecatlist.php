...
&nbsp;&nbsp;<a href="<?php echo $servicecat_list->PageUrl() ?>export=xml">导出到 XML</a>
...
<?php if ($servicecat->catname->Visible) { // catname ?>
	...
	<?php } else { ?>
		<td class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $servicecat->SortUrl($servicecat->catname) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr><td>类型名&nbsp;(*)</td><td style="width: 10px;"><?php if ($servicecat->catname->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($servicecat->catname->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></table>
		</td>
	<?php } ?>
<?php } ?>		
