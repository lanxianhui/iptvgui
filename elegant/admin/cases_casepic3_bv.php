...
// Define page object
$cases_casepic3_blobview = new ccases_casepic3_blobview();
$Page =& $cases_casepic3_blobview;

// Page init processing
$cases_casepic3_blobview->Page_Init();

// Page main processing
$cases_casepic3_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class ccases_casepic3_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'cases_casepic3_blobview';
	...
	//  - open connection
	//
	function ccases_casepic3_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('cases', 'x_casepic3');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('casepic3');
				if ($bShowThumbnail) {
