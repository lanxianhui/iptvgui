...
// Define page object
$cases_casepic8_blobview = new ccases_casepic8_blobview();
$Page =& $cases_casepic8_blobview;

// Page init processing
$cases_casepic8_blobview->Page_Init();

// Page main processing
$cases_casepic8_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class ccases_casepic8_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'cases_casepic8_blobview';
	...
	//  - open connection
	//
	function ccases_casepic8_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('cases', 'x_casepic8');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('casepic8');
				if ($bShowThumbnail) {
