...
// Define page object
$cases_casepic9_blobview = new ccases_casepic9_blobview();
$Page =& $cases_casepic9_blobview;

// Page init processing
$cases_casepic9_blobview->Page_Init();

// Page main processing
$cases_casepic9_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class ccases_casepic9_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'cases_casepic9_blobview';
	...
	//  - open connection
	//
	function ccases_casepic9_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('cases', 'x_casepic9');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('casepic9');
				if ($bShowThumbnail) {
