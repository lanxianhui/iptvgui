...
<?php } ?>
<p><span class="phpmaker">查看 表: Casesroot
<br><br>
<?php if ($casesroot->Export == "") { ?>
<a href="casesrootlist.php">回到列表</a>&nbsp;
...
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<a onclick="return ew_Confirm('你真的要删除吗?');" href="<?php echo $casesroot->DeleteUrl() ?>">删除</a>&nbsp;
<?php } ?>
<?php } ?>
</span></p>
...
<?php if ($casesroot->rootorder->Visible) { // rootorder ?>
	<tr<?php echo $casesroot->rootorder->RowAttributes ?>>
		<td class="ewTableHeader">根类排序</td>
...
<!--first page button-->
	...
	<td><a href="<?php echo $casesroot_view->PageUrl() ?>start=<?php echo $casesroot_view->Pager->FirstButton->Start ?>"><img src="images/first.gif" alt="第一页" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--previous page button-->
	...
	<td><a href="<?php echo $casesroot_view->PageUrl() ?>start=<?php echo $casesroot_view->Pager->PrevButton->Start ?>"><img src="images/prev.gif" alt="上一页" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="<?php echo $casesroot_view->PageUrl() ?>start=<?php echo $casesroot_view->Pager->NextButton->Start ?>"><img src="images/next.gif" alt="下一页" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="images/nextdisab.gif" alt="下一页" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($casesroot_view->Pager->LastButton->Enabled) { ?>
	<td><a href="<?php echo $casesroot_view->PageUrl() ?>start=<?php echo $casesroot_view->Pager->LastButton->Start ?>"><img src="images/last.gif" alt="最后页" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="images/lastdisab.gif" alt="最后页" width="16" height="16" border="0"></td>
	<?php } ?>
	<td><span class="phpmaker">&nbsp;总共 <?php echo $casesroot_view->Pager->PageCount ?></span></td>
	</tr></table>
<?php } else { ?>
