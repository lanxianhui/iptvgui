...
// Define page object
$service_servicepic_blobview = new cservice_servicepic_blobview();
$Page =& $service_servicepic_blobview;

// Page init processing
$service_servicepic_blobview->Page_Init();

// Page main processing
$service_servicepic_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cservice_servicepic_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'service_servicepic_blobview';
	...
	//  - open connection
	//
	function cservice_servicepic_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('service', 'x_servicepic');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('servicepic');
				if ($bShowThumbnail) {
