...
<span>&nbsp;&gt;&nbsp;</span>
<a href="index.php/main/contack/<?php echo $rootid ?>/<?php echo $selectcat ?>"><?php echo $entry["rootname"] ?></a>
<span>&nbsp;&gt;&nbsp;</span>
<a href="index.php/main/contack/<?php echo $rootid ?>/<?php echo $selectcat ?>">
...
<div class="lcontent">
<dl>
<dt><a href="index.php/main/contack/<?php echo $rootid ?>/<?php echo $selectcat ?>"><img src="images/0<?php echo $rootid ?>.jpg"/></a></dt>
...
<?php }else{?>
<li><a href="index.php/main/contack/<?php echo $rootid ?>/<?php echo $citem["id"] ?>"><?php echo $citem["catname"] ?></a></li>
<?php }?>
<?php endforeach;?>
</ul>
</dd>
...
<dl>
	...
	<li><a href="index.php/main/contackinfo/<?php echo $rootid ?>/<?php echo $selectcat ?>/<?php echo $listitem["id"] ?>/<?php echo $offset ?>"><?php echo $listitem["servicename"] ?></a>
