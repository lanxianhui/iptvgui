...
.pageBar a{display:block;background:#B6D450; color:#fff;float:left;width:16px;font-size:12px;margin:2px;text-align:center;line-height :16px;font-family:Arial;cursor:pointer;text-decoration:none;}
.pageBar a:hover,.pageBar a.current{background:#999999;color:#fff;}
</style>
<div id="icontent">
...
<div id="friend">
<ul>
	<li style="padding:25px 0;"><label class="title">友情链接:</label></li>
<?php
foreach ( $indexlink as $linkitem ) :
	?>
<li style="padding:25px 0;"><a href="<?php
