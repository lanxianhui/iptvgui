...
<?php if ($admin->username->Visible) { // username ?>
	<tr<?php echo $admin->username->RowAttributes ?>>
		<td class="ewTableHeader">登陆帐号</td>
		<td<?php echo $admin->username->CellAttributes() ?>>
<div<?php echo $admin->username->ViewAttributes() ?>><?php echo $admin->username->ViewValue ?></div></td>
	</tr>
<?php } ?>
<?php if ($admin->password->Visible) { // password ?>
	<tr<?php echo $admin->password->RowAttributes ?>>
		<td class="ewTableHeader">登陆密码</td>
		<td<?php echo $admin->password->CellAttributes() ?>>
<div<?php echo $admin->password->ViewAttributes() ?>><?php echo $admin->password->ViewValue ?></div></td>
	</tr>
<?php } ?>
</table>
</div>
