...
// Define page object
$partner_pimage_blobview = new cpartner_pimage_blobview();
$Page =& $partner_pimage_blobview;

// Page init processing
$partner_pimage_blobview->Page_Init();

// Page main processing
$partner_pimage_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cpartner_pimage_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'partner_pimage_blobview';
	...
	//  - open connection
	//
	function cpartner_pimage_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('partner', 'x_pimage');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('pimage');
				if ($bShowThumbnail) {
