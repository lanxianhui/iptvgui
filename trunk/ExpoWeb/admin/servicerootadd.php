...
<form name="fservicerootadd" id="fservicerootadd" action="<?php echo ew_CurrentPage() ?>" method="post">
<p>
...
<p>
<input type="button" name="btnAction" id="btnAction" value="    添加    " onclick="ew_SubmitForm(serviceroot_add, this.form);">
</form>
<script type="text/javascript">
<!--
