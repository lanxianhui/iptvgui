...
<dl>
	...
	<dd><form:form method="POST" action="addorder.service"
		...
		<table id="tableform">
			...
			<tr>
				<td>充值金额：<strong style="color: red;">￥</strong></td>
				<td class="labeltd"><form:input path="price" /></td>
				<td class="error"><form:errors path="price" /></td>
			</tr>
			<tr>
				<td></td>
				<td colspan="2" class="error">${orderErrorMessage}</td>
			</tr>
			<tr>
				<td></td>
				<td><input type="submit" id="sbutton" value="提交信息" /> <input
					type="reset" id="rbutton" value="重置表单" /></td>
				<td></td>
			</tr>
		</table>
	</form:form></dd>
