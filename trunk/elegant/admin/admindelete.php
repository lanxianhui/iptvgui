...
<?php echo $admin->TableCustomInnerHtml ?>
	...
	<tr class="ewTableHeader">
		<td valign="top">账号ID</td>
		<td valign="top">账号名称</td>
		<td valign="top">账号密码</td>
	</tr>
	</thead>
	<tbody>
<?php
...
<div<?php echo $admin->usename->ViewAttributes() ?>><?php echo $admin->usename->ListViewValue() ?></div></td>
		<td<?php echo $admin->usepass->CellAttributes() ?>>
<div<?php echo $admin->usepass->ViewAttributes() ?>><?php echo $admin->usepass->ListViewValue() ?></div></td>
	</tr>
<?php
	$rs->MoveNext();
}
