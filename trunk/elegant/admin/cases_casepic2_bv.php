...
// Define page object
$cases_casepic2_blobview = new ccases_casepic2_blobview();
$Page =& $cases_casepic2_blobview;

// Page init processing
$cases_casepic2_blobview->Page_Init();

// Page main processing
$cases_casepic2_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class ccases_casepic2_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'cases_casepic2_blobview';
	...
	//  - open connection
	//
	function ccases_casepic2_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('cases', 'x_casepic2');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('casepic2');
				if ($bShowThumbnail) {
