...
// Define page object
$cases_casepic5_blobview = new ccases_casepic5_blobview();
$Page =& $cases_casepic5_blobview;

// Page init processing
$cases_casepic5_blobview->Page_Init();

// Page main processing
$cases_casepic5_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class ccases_casepic5_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'cases_casepic5_blobview';
	...
	//  - open connection
	//
	function ccases_casepic5_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('cases', 'x_casepic5');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('casepic5');
				if ($bShowThumbnail) {
