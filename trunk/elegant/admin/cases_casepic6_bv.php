...
// Define page object
$cases_casepic6_blobview = new ccases_casepic6_blobview();
$Page =& $cases_casepic6_blobview;

// Page init processing
$cases_casepic6_blobview->Page_Init();

// Page main processing
$cases_casepic6_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class ccases_casepic6_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'cases_casepic6_blobview';
	...
	//  - open connection
	//
	function ccases_casepic6_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('cases', 'x_casepic6');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('casepic6');
				if ($bShowThumbnail) {
