...
// Define page object
$team_teampic_blobview = new cteam_teampic_blobview();
$Page =& $team_teampic_blobview;

// Page init processing
$team_teampic_blobview->Page_Init();

// Page main processing
$team_teampic_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cteam_teampic_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'team_teampic_blobview';
	...
	//  - open connection
	//
	function cteam_teampic_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('team', 'x_teampic');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('teampic');
				if ($bShowThumbnail) {
